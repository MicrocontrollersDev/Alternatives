...
| [MicroOptimizations](https://modrinth.com/mod/microoptimizations) | Caching and block pos pooling optimizations ported from Feather Client's open source optimization mod. | [Microcontrollers](https://github.com/MicrocontrollersDev) | This mod can sometimes cause ghost blocks to appear in worlds. These are purely visual and do not cause any issues such as rubberbanding. If it happens often, simply remove the mod from your mods folder. |
