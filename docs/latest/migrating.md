...
| [DarkKore](https://modrinth.com/mod/darkkore) (No 1.20.6 Yet) | KronHUD | [DarkKronicle](https://github.com/DarkKronicle) |
...
| [Exordium](https://modrinth.com/mod/exordium) (No 1.20.6 Yet) | Caps the FPS of certain HUD elements that do not need to be updated every frame. | [tr7zw](https://github.com/tr7zw) | [Fabric API](https://modrinth.com/mod/fabric-api) | | May break some HUD elements from other mods. |
| [DashLoader](https://modrinth.com/mod/dashloader) (No 1.20.6 Yet) | Caches all of Minecraft's contents to load the game much faster and provide insanely quick reloads. | [alphaqu](https://github.com/alphaqu) |
| [Enhanced Block Entities](https://modrinth.com/mod/ebe) (No 1.20.6 Yet) | Improves block entities by making them used baked models instead, allowing for better performance, visuals (via better smoothlighting), and better resource pack customizability. | [FoundationGames](https://github.com/FoundationGames) | [Fabric API](https://modrinth.com/mod/fabric-api) |
...
| [Audio Engine Tweaks](https://modrinth.com/mod/audio-engine-tweaks) (No 1.20.6 Yet) | Fixes the sound pool overloading, allowing for sounds to continue playing at all time and without log spam. | [mattymatty97](https://github.com/mattymatty97) |
...
| [Adaptive Tooltips](https://modrinth.com/mod/adaptive-tooltips) (No 1.20.6 Yet) | Makes tooltips more readable by preventing them from going off screen and allowing for tooltip scrolling, as well as more customization options such as custom transparency. | [isXander](https://github.com/isXander) | [Fabric API](https://modrinth.com/mod/fabric-api), [YACL](https://modrinth.com/mod/yacl) |
...
| [Distant Horizons](https://modrinth.com/mod/distanthorizons) (No 1.20.6 Yet) | Adds LODs to Minecraft, allowing for much further render distances without a big tank on performance. | [James Seibel](https://gitlab.com/jeseibel) | | | Many shaders may cause LODs to not load or be black. |
...
| [Pretty Hitboxes](https://modrinth.com/mod/pretty-hitboxes) (No 1.20.6 Yet)  | Allows you to customize hitboxes, similar to 1.8 mods and clients. | [ErrorGamer2000](https://github.com/nexensys) |
...
| [KronHUD](https://modrinth.com/mod/kronhud) (No 1.20.6 Yet) | Adds many useful HUD elements to your screen with an easy to use in game config. | [DarkKronicle](https://github.com/DarkKronicle) |
...
| [TNTTime](https://modrinth.com/mod/tnttime) (No 1.20.6 Yet) | Displays time left to the TNT explosion above primed TNT. | [Simon](https://github.com/shateq) |
...
| [Horse Stats Vanilla](https://modrinth.com/mod/horsestatsvanilla) (No 1.20.6 Yet) | Adds the stats of your horse in your horse/donkey inventory HUD, making it easy to see the perks of your horses and donkeys. | [d4m0n](https://github.com/d4rkm0nkey) |
...
| [Particle Tweaks](https://modrinth.com/mod/particle-tweaks) (No 1.20.6 Yet) | Makes particles look nicerby adding growing/fading effects and water physics. | [Lunade_](https://github.com/AViewFromTheTop) |
...
| [Highlight](https://modrinth.com/mod/highlight) (No 1.20.6 Yet) | Changes hitboxes to allow them to not be axis alligned, making them look much smoother on some blocks. | [Team Resourceful](https://github.com/Team-Resourceful) |
| [Biome Moss](https://modrinth.com/mod/biome-moss) | Improves the look of moss by adding color biome variation. | [TheDarkCoder](https://github.com/TheDarkCoder) | | | The latest release should work on 1.20.6. |
...
| [CIT Resewn](https://modrinth.com/mod/cit-resewn) (No 1.20.6 Yet)| Custom item textures. | ✅ | | [SHsuperCM](https://github.com/SHsuperCM) |
...
| [Custom Splash Screen](https://modrinth.com/mod/custom-splash-screen) (No 1.20.6 Yet) | Custom splash screen. | ⛔ | More customizable (than OptiFine and Puzzle). | [Motschen](https://github.com/Motschen) |
