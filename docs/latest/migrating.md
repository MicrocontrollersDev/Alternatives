...
| [Pack Manager](https://legacy.curseforge.com/minecraft/mc-mods/pack-manager) | A resource pack orgnizer mod. It allows you to sort resource packs into folders, as well as search for them using a search bar and change sorting order. | [enjarai](https://codeberg.org/enjarai) & [Microcontrollers](https://codeberg.org/MicrocontrollersDev) |
