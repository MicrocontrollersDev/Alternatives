...
| [Noisium](https://modrinth.com/mod/noisium) | Optimizes world generation when generating new chunks. | [Steveplays](https://github.com/Steveplays28) | | Only useful in singleplayer, can still use on multiplayer. |
...
| Mod | Description | Author | Incompatabilities | Notes |
| --- | --- | --- | --- | --- |
| [Nvidium (fork)](https://github.com/drouarb/nvidium/releases) | Nvidium uses NVIDIA only OpenGL extensions to greatly improve the game's performance. This mod will not work on AMD. It has a few graphical glitches and could lead to crashes, as the mod is still in beta and not considered stable yet. The mod will also disable itself whenever Iris shaders are enabled or if the required OpenGL extensions are not available. | [MCRcortex](https://github.com/MCRcortex) & [drouarb](https://github.com/drouarb) | | Chunks won't fade when using [Chunks Fade In](https://modrinth.com/mod/chunks-fade-in). |
...
| [Krypton](https://modrinth.com/mod/krypton) | This mod is theoretically not allowed on Hypixel, but after years of use, myself and countless others have never had any issues, and this mod should be completely safe to use. Krypton optimizes network stacking and entity tracking, as well as other micro-optimizations. | [astei](https://github.com/astei) |
